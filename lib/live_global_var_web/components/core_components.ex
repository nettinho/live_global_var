defmodule LiveGlobalVarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveGlobalVarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveGlobalVarWeb.Gettext, "errors", msg, opts)
    end
  end
